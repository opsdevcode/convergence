...
- Interruptions:
- Protocol deviations:
- Substantive coaching occurred:
- Analysis completed independently:

Elapsed time is descriptive only.

# Live Procedural / Coaching Log

| Timestamp/order | Practitioner question/action | Researcher response | Procedural or substantive classification | Notes |
| --- | --- | --- | --- | --- |
| | | | | |

Permitted procedural responses:
...
Prohibited substantive coaching:
...
Record every substantive clarification or coaching event.

# Original Analysis Freeze Record

**DO NOT EDIT THE FROZEN ORIGINAL ANALYSIS AFTER THIS POINT. Any later material
must be recorded separately.**

- Practitioner identifier:
- Analysis artifact/path:
- Freeze timestamp:
- Frozen before substantive discussion: yes/no
- Frozen before post-analysis questions: yes/no
- Frozen before seeing another analysis: yes/no
- Frozen before provenance: yes/no
- Frozen before held-back retrospective evidence: yes/no
- Substantive coaching before freeze: yes/no
- Known protocol deviations:
- Integrity/hash/commit reference if used:
...
**COMPLETE ONLY AFTER: original analysis is frozen; post-analysis questions
are complete; source-recognition check is complete.**

The retrospective is not an answer key.
...
- Practitioner claims unsupported by available evidence:
- Retrospective claims that are interpretations rather than observations:

# Researcher Classification — AFTER SESSION

Do not manufacture a numeric practitioner score. Do not decide
cross-participant thresholds in an individual session record. Do not create
specialty rankings.

- Recognizable application: established / not established
- Evidence for Scope:
- Evidence for Trace:
- Evidence for Diagnose:
- Evidence for Intervene:
- Evidence for Observe:
- Concrete incremental benefit: established / not established
- Practitioner's specific supporting statement/example:
- Method-induced distortion: established / not established
- Observed distortion mechanism, if any:
- Ambiguity notes:
- Relevant negative/falsifying outcome identifiers A-K:
- Protocol contamination/deviation notes:
